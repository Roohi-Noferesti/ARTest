...
public class GoalManager : MonoBehaviour
{
    ...
    [Tooltip("The Share Button to share a screenshot with it.")]
    [SerializeField]
    GameObject m_ShareButton;

    /// <summary>
    /// The Share Button to share a screenshot with it.
    /// </summary>
    public GameObject shareButton
    {
        get => m_ShareButton;
        set => m_ShareButton = value;
    }
